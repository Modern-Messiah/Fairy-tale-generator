...
**Веб-приложение для генерации детских сказок с использованием искусственного интеллекта**

Проект состоит из двух основных компонентов:
- **Python API** - бэкенд на FastAPI с интеграцией OpenAI GPT
...
2. Выберите возраст ребенка (3-5, 6-8, 9-10 лет)
